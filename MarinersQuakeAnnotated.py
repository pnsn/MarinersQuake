...
plot_end_time_local = pacific.localize(datetime(2025, 10, 17, 18, 0, 35))
video_start_local = pacific.localize(datetime(2025, 10, 17, 18, 0, 14))
video_end_local   = pacific.localize(datetime(2025, 10, 17, 18, 0, 35))
...
# 10x10 fig size:
annotations = [
    {"label": "Suarez hit...", "time": datetime(2025,10,17,18,0,16,int(0.8 * 1e6)), "x_text": datetime(2025,10,17,18,0,12, int(0.4 * 1e6)), "y_text": -0.04, "red_line_amp": 0.03},
    {"label": "Suarez slam!", "time": datetime(2025,10,17,18,0,21), "x_text": datetime(2025,10,17,18,0,16, int(0.1*1e6)), "y_text": 0.05, "red_line_amp": 0.05},
]
